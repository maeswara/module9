...
public class TestListener_Test extends TestListenerAdapter implements IInvokedMethodListener  {
	public void onTestSuccess(ITestResult tr){
		System.out.println("mani is passed");
		
	}
	

		public void onTestFailure(ITestResult tr){
			System.out.println("mani is failed");
			
		}
	
		public void onTestSkipped(ITestResult tr){
			System.out.println("mani is Skipped");
			
		}
		
		public void onTestStart(ITestResult tr){
			System.out.println("mani is started");
